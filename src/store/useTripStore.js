...
const useTripStore = create((set) => ({
  trips: [
    { id: '1', destination: 'Paris', date: '2025-03-01', details: 'A romantic getaway to Paris', participants: [] },
    { id: '2', destination: 'Tokyo', date: '2025-05-10', details: 'Exploring the vibrant city of Tokyo', participants: [] },
    { id: '3', destination: 'New York', date: '2025-06-15', details: 'Visiting iconic landmarks in New York', participants: [] },
  ],
